...
## Текущее состояние
Backend и frontend частично переписаны для работы с системой комнат и постоянными ID пользователей, но есть незавершенные задачи и потенциальные ошибки.
